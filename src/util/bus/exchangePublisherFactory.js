...
ExchangePublisherFactory.prototype.createExchangePublisher = function(exchangeName,callback) {
    ...
    */
    ...
    function on_channel_open(err, ch){
        ...
        ch.assertExchange(exchangeName+'Exchange', 'direct', exchangeOptions, function(err, ok) {
            if (err) {
                console.log(err);
                callback(null);
            } else {
    ...
    if (!self._channel) {
        ...
        self._channel.assertExchange(exchangeName+'Exchange', 'direct', exchangeOptions, function(err, ok) {
            if (err) {
                console.log(err);
                callback(null);
            } else {
